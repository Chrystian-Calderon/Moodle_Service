...
export class FormularioLeccionController {
  ...
  create(@Param("leccionId") leccionId: string, @Body() dto: CreateFormularioDto) {
  ...
  @UseGuards(JwtAuthGuard, PermissionGuard)
  @Permission("formularios.editar")
  update(@Param("id") id: string, @Body() dto: UpdateFormularioDto) {
  ...
  @UseGuards(JwtAuthGuard, PermissionGuard)
  @Permission("formularios.editar")
  updatePregunta(@Param("id") id: string, @Body() dto: UpdatePreguntaDto) {
  ...
  @UseGuards(JwtAuthGuard, PermissionGuard)
  @Permission("formularios.editar")
  addOpcion(@Param("id") id: string, @Body() dto: CreateOpcionDto) {
  ...
  @UseGuards(JwtAuthGuard, PermissionGuard)
  @Permission("formularios.editar")
  updateOpcion(@Param("id") id: string, @Body() dto: UpdateOpcionDto) {
